...
export default function OrderCard({icon, title, description, buttonText}: {icon: string, title: string, description: string, buttonText: string}) {
  return (
    <div className="flex flex-col items-center gap-3 py-4 lg:py-6 px-4 lg:px-16 lg:min-w-[480px] bg-white rounded-lg border mb-4">
        <img src={icon} className="w-[48px]" alt="icon" />
