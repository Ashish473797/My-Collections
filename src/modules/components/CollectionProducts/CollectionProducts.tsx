  ...
  return (
    <div className="container mx-auto px-4 md:px-24 mb-24">
          ...
          <div className="flex gap-3">
            ...
            >
              <div className="grid grid-cols-2 gap-1 p-2 cursor-pointer">
                <div
                  className={`w-2 h-[6px] ${
                    gridColunm === 2 ? "bg-gray-500" : "bg-gray-400"
            ...
            >
              <div className="grid grid-cols-4 gap-1 p-2 cursor-pointer">
                <div
                  className={`w-2 h-[6px] ${
                    gridColunm === 4 ? "bg-gray-500" : "bg-gray-400"
                  } group-hover:bg-gray-500 transition duration-200`}
                ></div>
                <div
                  className={`w-2 h-[6px] ${
            ...
            >
              <div className="grid grid-cols-6 gap-1 p-2 cursor-pointer">
                <div
                  className={`w-2 h-[6px] ${
                    gridColunm === 6 ? "bg-gray-500" : "bg-gray-400"
                  } group-hover:bg-gray-500 transition duration-200`}
                ></div>
                <div
                  className={`w-2 h-[6px] ${
      ...
      <div className="flex justify-center mt-16">
        <Button className="text-sm lg:text-base py-2 lg:py-3 px-5 lg:px-7">
          Show More Products
        </Button>
      </div>
    </div>
